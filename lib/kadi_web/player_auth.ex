defmodule KadiWeb.PlayerAuth do
  ...
  def log_out_player(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      KadiWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  Or use the `live_session` of your router to invoke the on_mount callback:
      ...
      live_session :authenticated, on_mount: [{KadiWeb.PlayerAuth, :ensure_authenticated}] do
