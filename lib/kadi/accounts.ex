defmodule Kadi.Accounts do
  ...
  alias Kadi.Accounts.{Player, PlayerToken, PlayerNotifier}
  ...
  defp confirm_player_multi(player) do
    ...
    |> Ecto.Multi.delete_all(:tokens, PlayerToken.by_player_and_contexts_query(player, ["confirm"]))
  end
