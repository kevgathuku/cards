defmodule KadiWeb.ConnCase do
  ...
  by setting `use KadiWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint KadiWeb.Endpoint

      use KadiWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import KadiWeb.ConnCase
    end
  end

  setup tags do
    Kadi.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_player(%{conn: conn}) do
    player = Kadi.AccountsFixtures.player_fixture()
  ...
  def log_in_player(conn, player) do
    token = Kadi.Accounts.generate_player_session_token(player)
