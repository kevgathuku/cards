defmodule KadiWeb.PlayerAuthTest do
  use KadiWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Kadi.Accounts
  alias KadiWeb.PlayerAuth
  import Kadi.AccountsFixtures

  @remember_me_cookie "_kadi_web_player_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, KadiWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_player/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      KadiWeb.Endpoint.subscribe(live_socket_id)
